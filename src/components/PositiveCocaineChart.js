              ...
              data-tip={`<div style='text-align: left; border: 1px solid #ccc; border-radius: 5px; padding: 10px; background-color: #fff;'>
                ...
                <div style='display: flex; align-items: center;'>
                  ...
                  <div>
                    ...
                    Cocaine positivity ${quarterlyChange !== null && quarterlyChange > 0 ? 'increased' : 'decreased'} from ${prevQuarter !== null ? prevQuarter.toFixed(1) : 'N/A'}% to ${curr.toFixed(1)}% in ${d.quarter}
                  </div>
                </div>
              </div>`}
