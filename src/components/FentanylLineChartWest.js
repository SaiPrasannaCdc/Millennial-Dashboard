...
const westQuarterlyData = [
  ...
  { quarter: 'Q2 2023', percentage: 19.4, ciLower: 18.9, ciUpper: 19.8 },
  { quarter: 'Q3 2023', percentage: 19.4, ciLower: 18.9, ciUpper: 19.9 },
  ...
  { quarter: 'Q3 2024', percentage: 20.1, ciLower: 19.6, ciUpper: 20.5 },
  { quarter: 'Q4 2024', percentage: 19.1, ciLower: 18.6, ciUpper: 19.5 },
];

const FentanylLineChartWest = ({ width = 1100, height = 450 }) => {
  const [showLabels, setShowLabels] = useState(false);
  const [showPercentChange, setShowPercentChange] = useState(false);

  const data = westQuarterlyData;
      ...
      <div style={{ backgroundColor: '#002b36', color: '#ffffff', padding: '10px 0' }}>
        <div style={{ textAlign: 'center' }}>
          <h3 style={{ margin: 0, fontSize: '18px', color: '#ffffff' }}>
            How often do people with a substance use disorder test positive for fentanyl on urine drug tests: Western Census Region Q1 2023 - Q4 2024. Millennium Health, Western Census Region Q1 2023 - Q4 2024
          </h3>
        </div>
      </div>
