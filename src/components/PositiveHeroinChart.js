              ...
              data-tip={`<div style='text-align: left; border: 1px solid #ccc; border-radius: 5px; padding: 10px; background-color: #fff;'>
                <div style='display: flex; align-items: center; margin-bottom: 10px;'>
                  ...
                  <div>
                    ...
                    Heroin positivity ${yearlyChange > 0 ? 'increased' : 'decreased'} from ${prevYear?.toFixed(1)}% to ${curr.toFixed(1)}% in ${d.quarter}
                  </div>
                </div>
                <div style='display: flex; align-items: center;'>
                  ...
                  <div>
                    ...
                    Heroin positivity ${quarterlyChange > 0 ? 'increased' : 'decreased'} from ${prevQuarter?.toFixed(1)}% to ${curr.toFixed(1)}% in ${d.quarter}
                  </div>
                </div>
              </div>`}
