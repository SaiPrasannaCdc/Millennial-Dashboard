  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      <div style={{ backgroundColor: '#002b36', color: '#ffffff', padding: '10px 0' }}>
        <div style={{ textAlign: 'center' }}>
          <h3 style={{ margin: 0, fontSize: '18px', color: '#ffffff' }}>
            How often do people with a substance use disorder test positive for methamphetamine on urine drug tests: Northeastern Census Region {is6Months ? 'Jan 2023 - Dec 2024 (6 Months)' : 'Q1 2023 - Q4 2024'}. Millennium Health, Northeastern Census Region {is6Months ? 'Jan 2023 - Dec 2024' : 'Q1 2023 - Q4 2024'}
          </h3>
        </div>
      </div>
      <div style={{
      ...
      <>
        ...
        {UtilityFunctions.getToggleControls('MethamphetamineLineChartNortheastToggle', setShowPercentChange, setShowLabels, showPercentChange, showLabels)}
