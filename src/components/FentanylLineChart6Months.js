...
const FentanylLineChart6Months = ({ region = 'National', width, height }) => {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      {UtilityFunctions.getToggleControls('FentanylLineChart6MonthsToggle', setShowPercentChange, setShowLabels, showPercentChange, showLabels)}
