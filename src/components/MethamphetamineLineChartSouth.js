  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <>
       ...
       {UtilityFunctions.getToggleControls('MethamphetamineLineChartSouthToggle', setShowPercentChange, setShowLabels, showPercentChange, showLabels)}
